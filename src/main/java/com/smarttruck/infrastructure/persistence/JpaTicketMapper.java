...
public class JpaTicketMapper {
    public Ticket toDomain(JpaTicket e) {
        ...
        return new Ticket(e.getId(), e.getCustomerId(), e.getDescription(),
            TicketStatus.valueOf(e.getStatus()), e.getCreatedAt(), e.getUpdatedAt(),
            e.getDeletedAt());
    }

    public JpaTicket toEntity(Ticket t) {
        if (t == null) return null;
        return new JpaTicket(t.getId(), t.getCustomerId(), t.getDescription(), t.getStatus().name(),
